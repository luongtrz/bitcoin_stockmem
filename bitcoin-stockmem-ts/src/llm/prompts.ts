 ...
 * Adapted from StockMem paper Appendix B for cryptocurrency.
 */

// 1. LLM_ext — Event extraction
...
// 2. LLM_merge — Merge duplicate events
...
// 4. LLM_reason — Reflection (training, from paper Appendix B)
...
// 5. LLM_retrieve — Filter candidate sequences
export const RETRIEVE_PROMPT = `\
...
// 6. LLM_predict — Final prediction (from paper Appendix B)
